    ...
    <div className="w-64 bg-white border-r border-gray-200 flex flex-col h-full overflow-hidden">
      ...
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-lg font-semibold text-gray-800">我的小说</h2>
          <button
              ...
              <li key={novel.id}>
                ...
                >
                  <BookOpen className={`w-5 h-5 flex-shrink-0 mt-0.5 ${
                    currentNovel?.id === novel.id ? 'text-blue-500' : 'text-gray-400'
                  }`} />
      ...
      <div className="p-4 border-t border-gray-200">
        <button
          ...
          className="w-full px-4 py-2 flex items-center gap-2 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors"
        >
